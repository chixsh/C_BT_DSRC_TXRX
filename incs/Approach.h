...
typedef struct Approach {
    ...
    struct Approach__drivingLanes {
        A_SEQUENCE_OF(struct VehicleReferenceLane)
    ...
    struct Approach__computedLanes {
        A_SEQUENCE_OF(struct VehicleComputedLane)
    ...
    struct Approach__trainsAndBuses {
        A_SEQUENCE_OF(struct SpecialLane)
    ...
    struct Approach__barriers {
        A_SEQUENCE_OF(struct BarrierLane)
    ...
    struct Approach__crosswalks {
        A_SEQUENCE_OF(struct CrosswalkLane)
