...
typedef enum {
    use_start_validity = 0, lifetime_is_duration = 1, encryption_key = 2
...
typedef enum {
    ecdsa_nistp224_with_sha224 = 0, ecdsa_nistp256_with_sha_256 = 1, ecies_nistp256 = 2
} PKAlgorithm;

typedef enum {
    x_coordinate_only = 0, compressed_lsb_y_0 = 1, compressed_lsb_y_1 = 2, uncompressed = 3
} EccPublicKeyType;
...
typedef enum {
    from_issuer_region = 0, circle = 1, rectangle = 2, polygon = 3, none = 4
} RegionType;
