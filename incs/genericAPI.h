...
void msg_create_sign_msg(UINT8 *buff, UINT8 *buf, int *buffSize, int, UINT8, unsigned int *psid, int psidLen,
                         UINT8 generationLocation, long generationLatitude_tx, long generationLongitude_tx);

void msg_create_verify_msg(const UINT8 *signBuff, UINT8 *buff, int *buffSize, UINT32 msgValidityDistance,
                           UINT8 detectReplay, UINT8 generationLocationValidity, long local_latitude,
...
void msg_create_sign_wsa(UINT8 *buff, UINT8 *data, UINT16 *buffSize, UINT16 length, UINT32 *, UINT32 latitude,
                         UINT32 longitude, UINT16 elevation);
...
extern void msg_create_misbehavior_report(UINT8 *buff, int *buffSize, UINT8 *report_data, UINT32 report_data_length,
                                          long latitude, long longitude, UINT8 *elevation);
